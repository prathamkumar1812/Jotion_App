...
import { LoaderIcon, Search, Trash, Undo } from "lucide-react";
import { Input } from "@/components/ui/input";
import Conform from "@/components/models/Conform";
  ...
  return (
    ...
    className="text-sm ">
        ...
        <div className="mt-2 px-1 pb-1 ">
            <p className="hidden last:block text-center text-muted-foreground text-xs pb-2">No document found</p>
             {
                filteredDocuments?.map((document)=>(
                    ...
                    className="text-sm rounded-sm w-full hover:bg-primary/5 flex items-center text-primary justify-between">
                        ...
                        <div className="flex items-center">
                            ...
                            <Conform onConform={()=>onRemove(document._id)}> 
                            <div role="button"
